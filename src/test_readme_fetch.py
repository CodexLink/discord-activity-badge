...
async def main():
	...
	pattern_regex = compiled_regex.match("[![Discord Rich Presence](https://badgen.net/badge/Discord%20Rich%20Presence/Under%20Development?icon=discord)](https://github.com/CodexLink/discord-rich-presence-activity-badge)")
